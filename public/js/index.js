	...
	var questionTpl = doT.compile([
		...
		'<div class="question-wrapper col-md-6 col-md-offset-3 {{?!q.show}}hide{{?}}" id="num-{{=q.num}}">',
    			...
    			'<div class="answer">',
    				...
    				'{{~}}',
    				'{{?k !== 0}}',
    				'<button type="button" class="btn btn-back btn-lg">返回</button>',
    				'{{?}}',
    			'</div>',
    			'<div class="ad">',
    				'<img src="{{=q.ad}}" alt="面包">',
		...
		questions = '1、吃西瓜喜欢这样吃,2、口香糖一次吃,3、喝饮料时这样,4、喜欢这样对待塑料上的小泡泡,5、喜欢这样的位置,6、看到反光的东西第一反应是,7、 被蚊子咬了个包的反应是,8、一个人喝酸奶时,9、在陌生人面前与在熟悉人面前，你的表现差异大吗？,10、如果要买夜宵给男友，你会买什么？,11、你因为工作的事情而经常熬夜吗？,12、早餐和下午茶最喜欢？'.split(','),
		...
		btnActions = '3,2,4;3,4,6;5,7,6;8,9,7;6,9,8;9,8,7;8,9,10;10,9,6;10,7,11;A,11,12;C,12,9;B,D,E'.split(';'),
